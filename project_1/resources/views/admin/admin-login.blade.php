              ...
              <div class="card-body">
                ...
                <form action="{{ url('admin_auth') }}" method="post">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="password" name="password" class="form-control" id="exampleInputPassword1" value="<?php if(request()->cookie('cpass')) { echo request()->cookie('cpass'); }?>" required>
                  </div>
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="form-check">
                      <input class="form-check-input primary" type="checkbox" value="remember" name="rem" id="flexCheckChecked" checked>
