 <footer class="ftco-footer ftco-bg-dark ftco-section">
  ...
  <script src="{{url ('website/js/jquery-migrate-3.0.1.min.js')}}"></script>
  ...
  <script src="{{url ('website/js/jquery.waypoints.min.js')}}"></script>
  ...
  <script src="{{url ('website/js/jquery.animateNumber.min.js')}}"></script>
  <script src="{{url ('website/js/bootstrap-datepicker.js')}}"></script>
  <script src="{{url ('website/js/jquery.timepicker.min.js')}}"></script>
  <script src="{{url ('website/js/scrollax.min.js')}}"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="{{url ('website/js/google-map.js')}}"></script>
